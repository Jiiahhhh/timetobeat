    ...
    >
      {game.cover_portrait_url ? (
        <img
          ...
          alt={game.title}
          className="w-12 h-16 object-cover rounded-sm shrink-0 shadow-sm"
        />
      ) : (
        <div className="w-12 h-16 bg-[#1b2838] rounded-sm shrink-0 flex items-center justify-center text-lg shadow-sm">
          🎮
        </div>
      )}
